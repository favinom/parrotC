...
[Postprocessors]
[./MMP_eps11_real]   type = AttenuationDispersionFast UserObjectName = myUO i = 0 j = 0 operation_type = STRAIN      component = REAL [../]
[./MMP_eps12_real]   type = AttenuationDispersionFast UserObjectName = myUO i = 0 j = 1 operation_type = STRAIN      component = REAL [../]
[./MMP_eps22_real]   type = AttenuationDispersionFast UserObjectName = myUO i = 1 j = 1 operation_type = STRAIN      component = REAL [../]
[./MMP_sigma11_real] type = AttenuationDispersionFast UserObjectName = myUO i = 0 j = 0 operation_type = STRESS      component = REAL [../]
[./MMP_sigma12_real] type = AttenuationDispersionFast UserObjectName = myUO i = 0 j = 1 operation_type = STRESS      component = REAL [../]
[./MMP_sigma22_real] type = AttenuationDispersionFast UserObjectName = myUO i = 1 j = 1 operation_type = STRESS      component = REAL [../]
[./MMP_eps11_imag]   type = AttenuationDispersionFast UserObjectName = myUO i = 0 j = 0 operation_type = STRAIN      component = IMAG [../]
[./MMP_eps12_imag]   type = AttenuationDispersionFast UserObjectName = myUO i = 0 j = 1 operation_type = STRAIN      component = IMAG [../]
[./MMP_eps22_imag]   type = AttenuationDispersionFast UserObjectName = myUO i = 1 j = 1 operation_type = STRAIN      component = IMAG [../]
[./MMP_sigma11_imag] type = AttenuationDispersionFast UserObjectName = myUO i = 0 j = 0 operation_type = STRESS      component = IMAG [../]
[./MMP_sigma12_imag] type = AttenuationDispersionFast UserObjectName = myUO i = 0 j = 1 operation_type = STRESS      component = IMAG [../]
[./MMP_sigma22_imag] type = AttenuationDispersionFast UserObjectName = myUO i = 1 j = 1 operation_type = STRESS      component = IMAG [../]
[./attenuationFast]  type = AttenuationDispersionFast UserObjectName = myUO i = 1 j = 1 operation_type = ATTENUATION             [../]
 [./dispersionFast]  type = AttenuationDispersionFast UserObjectName = myUO i = 1 j = 1 operation_type = DISPERSION              [../]
[]

[UserObjects]
[./myUO] type = AttenuationDispersionUO execute_on = timestep_end material_name = mymat [../]
[]


[Outputs]
 file_base = oldMesh_oldAssembly_newPostprocessor
# exodus = true
 csv = true
