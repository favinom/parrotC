...
[Mesh]
file = 'mesh_${nel}_${amr}_${dbrString}.xdr'
...
[./disp_y_periodic] variable = disp_y auto_direction = 'x y' [../]
...
[Outputs]
 file_base = output_${nel}_${amr}_${dbrString}
 exodus = true
 csv = true
...
[./expt] type = ExportStressStrain execute_on =  'timestep_end'      output_filename = stress_${nel}_${amr}_${dbrString}.e   material_name = freqPoroelasticFracture2D [../]
[]
