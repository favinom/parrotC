...
[Outputs]
 file_base = outputRelaxation_${xcParrot}_${ycParrot}
 exodus = true
 csv = true
...
[./expt] type = ExportStressStrain execute_on =  'timestep_end'      output_filename = stressRelaxation__${xcParrot}_${ycParrot}.e   material_name = freqPoroelasticFracture2D [../]
[]
