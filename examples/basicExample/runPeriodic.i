...
[UserObjects]
[./myUO] type = AssembleFreqPoroelasticityInclusionPeriodicBC execute_on = initial      material_name = freqPoroelasticFracture2D center_x = true center_y = true
         direction = y bc_value_real = '0 -1e-3' bc_value_imag = '0 0' [../]
