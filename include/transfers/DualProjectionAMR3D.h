...
#ifndef DualProjectionAMR3D_H
#define DualProjectionAMR3D_H
 ...
 */
class DualProjectionAMR3D : public MultiAppTransfer
{
public:
    DualProjectionAMR3D(const InputParameters & parameters);
    
    virtual void initialSetup() override;
    
    virtual void execute() override;
    
    virtual ~DualProjectionAMR3D();
