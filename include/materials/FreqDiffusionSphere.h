...
#ifndef FREQDIFFUSIONSPHERE_H
#define FREQDIFFUSIONSPHERE_H

#include "Material.h"

//Forward Declarations
class FreqDiffusionSphere;
 ...
 */
class FreqDiffusionSphere : public Material
{
public:
  FreqDiffusionSphere(const InputParameters & parameters);
