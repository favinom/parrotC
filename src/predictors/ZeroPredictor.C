...
template<>
InputParameters validParams<ZeroPredictor>()
{
...
ZeroPredictor::ZeroPredictor(const InputParameters & parameters) :
    Predictor(parameters)
{
}

bool
ZeroPredictor::shouldApply()
{
...
void
ZeroPredictor::apply(NumericVector<Number> & sln)
{
...
//  {
    sln *= 0.0; //(1.0 + dt_adjusted_scale_factor);
//    sln.add(-1.0, sln);
//  }
}
